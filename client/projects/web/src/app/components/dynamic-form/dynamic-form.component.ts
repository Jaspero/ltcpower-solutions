import {Component, OnInit, ChangeDetectionStrategy, ElementRef, ChangeDetectorRef, Input} from '@angular/core';
...
export class DynamicFormComponent extends CommonBlockComponent {
