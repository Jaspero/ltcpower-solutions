          ...
          templates: [
            {
              ...
              style: `.body{font-family:Open Sans, sans-serif;font-size:18px;font-weight:lighter;color:#09371f;background:#FFFFFF}.footer-content,.header-content,.main-content{padding:3ch 2ch 3ch 0;max-width:52ch;margin:1ch auto;}.main-content{padding-left:2ch;background:#fff;border-radius:1ch;border:1px solid #cdd7d2}.footer-content>*{font-size:.875rem}.logo{display:block;margin:auto}section{border-left:4px solid #cdd7d2;padding:1px 0 1px 1em;margin:2em 0}hr{outline:0;border:none;border-top:1px dashed #cdd7d2;margin:2em 0}.button{display:inline-block;margin:2ch 0;background:#e66439;color:#fff!important;font-size:.875rem;font-family:inherit;padding:1.5ch 2ch;border:none;border-radius:.5ch;cursor:pointer;text-decoration:none;}.button:hover{outline:2px dashed #e66439;outline-offset:4px}.button:disabled{opacity:.5;pointer-events:none}h1,h2{font-family:Open Sans, sans-serif;font-weight:inherit}h1{font-size:2rem;margin:.5em 0}h2{font-size:1.5rem;margin:.75em 0}h3{margin:.875em 0;font-size:1.125rem;font-weight:400}.image{max-width:100%}`,
              segments: [
                {
                  id: 'section',
                  name: 'Section',
